...
<div class="wrapper">
  ...
  <div align="center">
    <?php if($row['status'] == "Pending") { ?>
      <!-- Show Approve and Reject for Pending status -->
      <a href="process_leave.php?action=approve&id=<?php echo $row['leaveID']; ?>" onClick="return approve('<?php echo $row['fullname']; ?>');"><i class="fa fa-check" title="Approve"></i></a>
      <a href="process_leave.php?action=reject&id=<?php echo $row['leaveID']; ?>" onClick="return decline('<?php echo $row['fullname']; ?>');"><i class="fa fa-times kolor="red" title="Reject"></i></a>
    <?php } else { ?>
      <!-- Allow reversing status -->
      <?php if($row['status'] == "Approved") { ?>
        <a href="process_leave.php?action=reject&id=<?php echo $row['leaveID']; ?>" onClick="return decline('<?php echo $row['fullname']; ?>');"><i class="fa fa-times" title="Reject"></i></a>
      <?php } elseif($row['status'] == "Declined") { ?>
        <a href="process_leave.php?action=approve&id=<?php echo $row['leaveID']; ?>" onClick="return approve('<?php echo $row['fullname']; ?>');"><i class="fa fa-check" title="Approve"></i></a>
      <?php } ?>
    <?php } ?>
    <a href="delete-leave.php?id=<?php echo $row['leaveID'];?>" onClick="return deldata('<?php echo $row['fullname']; ?>');">Delete</a>
  </div>
</td>
                    </tr>
                    <?php $cnt=$cnt+1;} ?>
