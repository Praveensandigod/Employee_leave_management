...
include('../inc/topbar.php'); 
    ...
    $statement->execute([
       ...
       ':sex' => $_POST['cmdsex'],
        ...
        ':dob' => '', // You can update this when date input is added
        ':phone' => $_POST['txtphone'],
        ':address' => '', // Add input if required
        ':qualification' => '', // Add input if required
        ':dept' => $_POST['cmddept'],
        ':employee_type' => $_POST['cmdemployeetype'],
        ':date_appointment' => '', // You can update this when date input is added
